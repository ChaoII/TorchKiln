...
class YoloDepthTask(TaskAdapter):
    ...
    def build_post_process(self, config):
        from torchkiln.depth import build_depth_postprocess
    ...
    def train_collate(self, batch):
        from torchkiln.data.depth import train_collate

        return train_collate(batch)

    def eval_collate(self, batch):
        from torchkiln.data.depth import eval_collate
