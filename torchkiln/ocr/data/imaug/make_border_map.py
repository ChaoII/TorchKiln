...
class MakeBorderMap(object):
    ...
    def draw_border_map(self, polygon, canvas, mask, shrink_ratio=None):
        ...
        # Guard against degenerate boxes that would produce mismatched slice
        # shapes (e.g. a zero-width polygon after clipping).
        if xmax_valid <= xmin_valid or ymax_valid <= ymin_valid:
            return
