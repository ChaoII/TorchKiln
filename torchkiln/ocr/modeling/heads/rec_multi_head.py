...
from torchkiln.ocr.modeling.necks.rnn import Im2Seq, SequenceEncoder
...
class MultiHead(nn.Module):
    def __init__(self, in_channels, out_channels_list, **kwargs):
        ...
        self.use_aux_head = kwargs.pop('use_aux_head', True)
    ...
    def forward(self, x, data=None):
        ...
        if not self.use_aux_head:
            # CTC-only training: keep dict layout so MultiLoss can slice batch
            return head_out
